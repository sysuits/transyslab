...
public class CoordTransformUtils {
    ...
    public static GeoPoint plane2latlon(GeoPoint point, GeoPoint shift){
        ...
        plane2latlon.transform(new ProjCoordinate(point.getLocationX() + shift.getLocationX(),point.getLocationY() + shift.getLocationY()),
                tfCoordinate);
        return new GeoPoint(tfCoordinate.x,tfCoordinate.y,0);
    }
    public static GeoPoint latlon2plane(GeoPoint point, GeoPoint shift){
        ProjCoordinate tfCoordinate = new ProjCoordinate();
        latlon2plane.transform(new ProjCoordinate(point.getLocationX() ,point.getLocationY() ,point.getLocationZ()),
                tfCoordinate);
        return new GeoPoint(tfCoordinate.x- shift.getLocationX(),tfCoordinate.y- shift.getLocationY(),0);
    }
    public static GeoPoint plane2latlon(GeoPoint point){
        ProjCoordinate tfCoordinate = new ProjCoordinate();
        plane2latlon.transform(new ProjCoordinate(point.getLocationX(),point.getLocationY()),
                tfCoordinate);
        return new GeoPoint(tfCoordinate.x,tfCoordinate.y,0);
    }
    ...
    public static GeoPoint projection(GeoPoint point, String espgSource, String espgTarget){
        ...
        ProjCoordinate tfCoordinate = new ProjCoordinate();
        bct.transform(new ProjCoordinate(point.getLocationX() ,point.getLocationY() ,point.getLocationZ()),
                tfCoordinate);
        return new GeoPoint(tfCoordinate.x,tfCoordinate.y,point.getLocationZ());
    }
}
