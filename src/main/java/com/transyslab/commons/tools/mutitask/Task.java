...
public class Task {
	...
	public Task(double[] arg_inputs, String workerName) {
		this();
		init(arg_inputs,workerName);
	}

	public void init(double[] arg_inputs, String workerName) {
		inputVariables = arg_inputs;
		this.workerName = workerName;
	}

	public void anyWorker(){
		this.workerName = TaskWorker.ANY_WORKER;
	}
	...
	protected void setResults(double[] objectiveVals) {
		this.objectiveValues = objectiveVals;
	}

	public synchronized void announceReady(){
		canRetrieve = true;
