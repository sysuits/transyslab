...
public class AppSetup {
	...
	public static void setEngineClass(String modelType){
		if (modelType.contains("Meso"))
			engineClass = MesoEngine.class;
		else if (modelType.contains("MLP"))
			engineClass = MLPEngine.class;
	}
}
