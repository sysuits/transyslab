...
//	protected float[] queueParam; // max speed for queue releasing
	public final static float VEHICLE_LENGTH = 4.6f; // 单位米， 20 feet //wym 改为4.6米
...
/*	public float queueReleasingSpeed(float t, float v_f) {
	...
	public double alertDis(){
		return PHYSICAL_SPD_LIM * simStepSize;
	}

	public double displacement(double speed){
		return speed * simStepSize;
	}
