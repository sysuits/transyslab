...
public class MesoVehicle extends Vehicle {
	...
	/*
	 * public int loadSimulationFiles(int id, int ori, int des, int type_id, int path_id ) //
...
//        setPath(VehicleTable.getInstance().getPath());
	...
	public void initialize(MesoParameter params, MesoRandom random) // called by loadSimulationFiles()
	{
		flags = 0;
		sensorIDFlag = -100000;
