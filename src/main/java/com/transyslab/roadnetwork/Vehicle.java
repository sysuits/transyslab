...
//	protected ODPair od; // od pair
	...
	/*
	public void loadSimulationFiles(int id, int t, ODPair od, Path p) {
		this.id = id;
		// TODO 处理id自增
		/*
	...
	/*
    public void loadSimulationFiles(int id, int t, double len, double dis,double departtime){
		this.id = id;
        this.type = t;
        // TODO 下移
...
//        setPath(VehicleTable.getInstance().getPath());
	 ...
	 *
	 * int error = loadSimulationFiles(id, type_id, od, getPath);
	 *
	 * PretripChoosePath();
	 *
	 * return (error); }
